...
import { Container, Heading, FormControl, FormLabel, Input, Button, Stack, NumberInput, NumberInputField, Textarea } from '@chakra-ui/react'
    ...
    <Container maxW="container.sm" py={8}>
      ...
      <Stack spacing={4} as="form" onSubmit={handleSubmit}>
        <FormControl>
          ...
          <Input value={title} onChange={(e) => setTitle(e.target.value)} placeholder="Nom" required />
        </FormControl>
        <FormControl>
